...
<p>Data Source: <a target="_blank" href="${WEB_PROPERTIES['phytomine.url']}">Phytozome</a></p>
</div>
 ...
 <script type="text/javascript">
   ...
   var formatLink = function(url, text, target, cls){
    ...
    var formatPhytomineLink = function(id, dataClass, value) {
        var medicmine_url = '/${WEB_PROPERTIES['webapp.path']}' + '/portal.do?class=' + dataClass + '&externalids=' + id;
        var thalemine_url = '${WEB_PROPERTIES['thalemine.url']}' + '/portal.do?class=' + dataClass + '&externalids=' + id;
