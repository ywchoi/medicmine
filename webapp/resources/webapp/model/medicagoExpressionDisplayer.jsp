...
<style>
  #medicago-expression div.data-table { margin-top:20px; }
</style>

<div id="medicago-expression">
  ...
  <c:otherwise>
    ...
    <script type="text/javascript">
      function drawChart() {
          ...
          var n = 0;
          <c:forEach var="stage" items="${medicagoResults}">
            data.addRows(1);
          ...
          <%-- aim & shoot --%>
          var chart = new google.visualization.BarChart(document.getElementById("medicago-expression-chart"));
      ...
      <%-- toggle table --%>
      jQuery("#medicago-expression input.toggle").click(function() {
        jQuery("#medicago-expression div.collection-table").toggle();
      });
    </script>
